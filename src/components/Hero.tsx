            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 leading-tight mb-6">
                        Stay Safe Online — Learn to Spot Phishing with <span className="text-blue-500">Fish-Pish</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <Link href="/quiz" className="bg-white text-slate-700 px-6 py-3 rounded-2xl font-semibold border border-slate-200 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 active:scale-95">
                            Jump to Quiz
                        </Link>
                    </div>
                </motion.div>
