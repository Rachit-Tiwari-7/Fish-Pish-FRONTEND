...
export default function Chatbot() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'bot', content: "Hi! I'm Fish-Pish Assistant. Got any questions about the quiz or cyber security? I'm here to help!" }
    ]);
                    ...
                    >
                        ...
                        <div className="bg-blue-600 p-4 text-white flex items-center justify-between shadow-md">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-bold">Fish-Pish Assistant</span>
                            </div>
