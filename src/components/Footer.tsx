    ...
    return (
        <footer className="bg-white border-t border-slate-100 pt-20 pb-10 px-6">
            <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
                <div className="col-span-2">
                    <div className="flex items-center gap-2 mb-6">
                        <img src="/FP_LOGO.png" alt="Fish-Pish Logo" className="h-8 w-auto" />
                        <span className="text-2xl font-bold text-slate-900">Fish-Pish</span>
                    </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-slate-500">
                        <li><a href="/learn" className="hover:text-blue-500 transition-colors">Cyber Hygiene</a></li>
                        <li><a href="/learn" className="hover:text-blue-500 transition-colors">Spotting Phishing</a></li>
                        <li><a href="/tools" className="hover:text-blue-500 transition-colors">Interactive Challenge</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-slate-500">
                        <li><a href="/extension" className="hover:text-blue-500 transition-colors">Chrome Extension</a></li>
                        <li><a href="/about" className="hover:text-blue-500 transition-colors">About Us</a></li>
                        <li><a href="/tools" className="hover:text-blue-500 transition-colors">Student Guide</a></li>
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
                <p>© 2024 Fish-Pish Cybersecurity Education. Built for the Hackathon.</p>
